...
module.exports.displayEventPage = (req, res, next) => {
    res.render('event', {title: 'Events', displayName: req.user ? req.user.displayName : ''});
}

module.exports.displayCoursePage = (req, res, next) => {
    res.render('course', {title: 'Course', displayName: req.user ? req.user.displayName : ''})
}

module.exports.displayFacultyPage = (req, res, next) => {
    res.render('faculty', {title: "Faculty", displayName: req.user ? req.user.displayName : ''})
}

module.exports.displayStudentPage = (req, res, next) => {
    res.render('student', {title: "Student", displayName: req.user ? req.user.displayName : ''})
}
